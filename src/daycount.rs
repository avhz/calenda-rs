...
use crate::conventions::day_counting_conventions::DayCountConvention;
use core::panic;
...
impl DayCounter {
    /// New day counter.
    #[must_use]
    pub fn new(start: Date, end: Date, convention: DayCountConvention) -> Self {
    ...
    #[must_use]
    pub fn day_count_factor(start: Date, end: Date, convention: &DayCountConvention) -> f64 {
        // THIS FUNCTION NEEDS WORK.

        // let start = start.unwrap_or(Date::now_utc());
        ...
        match convention {
            ...
            _ => panic!("Day count convention not implemented."),
    ...
    #[must_use]
    pub fn day_count_business(mut start: Date, end: Date) -> i64 {
        let mut count = 0;
        while start <= end {
            match start.weekday() {
    ...
    #[must_use]
    pub fn day_count_calendar(start: Date, end: Date) -> i64 {
